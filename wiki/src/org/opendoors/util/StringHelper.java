...
/**
 *  A class with several String utilities. <p>
 *
 *  It contains localization utilities, such as static methods for converting
 *  strings from and to the default platform representation using a certain
 *  character encoding (using JDK codes for the converter). <p>
 *
 *  This class also has methods to take lists of supported locales and character
 *  encoding names and their corresponding 'JDK codes'. Those codes can be used
 *  for setting the encoding of widgets. There is a method that returns the
 *  correct code for a given name (not case sensitive) and a method that returns
 *  the name for a given code.
 *
 ...
 *@see        #getEncodingCode(String)
 *@see        #getEncodingName(String)
 *@see        #getLocaleNames(String)
 *@version    1.8, 12/18/97
 */
public class StringHelper {
	final static boolean JDK10 = false;
	...
	/**
	 *  Converts byte array to string, using one character per byte. NOTE: this
	 *  method does NOT use the JDK encoding mechanism!
	 *
	...
	/**
	 *  Converts String to bytes, using one byte per character. NOTE: this method
	 *  does NOT use the JDK encoding mechanism!
	 *
	...
	/**
	 *  Replace all occurences of string one with string two. It does not replace
	 *  if a string has an escape character in front of it ('\').
	 *
	...
	/**
	 *  Convert a string with the default platform encoding to a string with the
	 *  given encoding.
	 *
	 *@param  s         The string with default encoding that needs to be
	 *      converted.
	...
	/**
	 *  Convert a character in the default encoding to the given character
	 *  encoding.
	 *
	...
	/**
	 *  Converts a string with the given encoding to a string in the default
	 *  encoding. You must Make sure to supply the correct encoding for this
	 *  string.
	 *
	 *@param  s         The string with the given encoding that needs to be
	...
	/**
	 *  Compares one byte array to the other and returns true if they are identical
	 *  in length and value.
	 *
	...
	/**
	 *  Get the name of the given encoding code. The case of the given code is
	 *  ignored. It returns null if the code is not found.<p>
	 *
	 *  <b>We do not use the IANA names for the encoding names, since these names
	 *  try to be more descriptive.</b> That is why the encoding of a widget cannot
	 *  be set using the encoding names; to do that the encoding <i>codes</i> must
	 *  be used. These encoding codes are the codes for each JDK character
	...
	/**
	 *  Get the code of the given encoding name. The case of the given name is
	 *  ignored. It returns null if the name is not found. <b>The encoding code
	 *  must be used to set the encoding of a widget properly.</b>
	 *
	 *@param  name  Description of the Parameter
	 *@return       The encodingCode value
	 *@see          #getEncodingName
	 ...
	 *@see       #getEncodingNames public static String[] getLocaleNames() {
	 *      Locale[] localeList = (new java.text.resources.LocaleData()).getAvailableLocales(null);
	 *      String[] names = new String[localeList.length]; for (int i = 0; i <
	 *      localeList.length; i++) { names[i] = localeList[i].getDisplayName() +
	 *      "[" + localeList[i].toString() + "]"; } return names; }
	 */

	/**
	 *  The encoding table, with the name for each encoding and for each name the
	 *  proper encoding code that is the code for the JDK character encoding class.
	 */
