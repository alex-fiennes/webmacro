...
/**
 *  A simplified interface for (full-text) indexing WikiPages. Once indexed, the
 *  page can be found via a corresponding WikiPageFinder.<p>
 *
 *
 *
 *@author     e_ridge
...
public interface WikiPageIndexer {
	...
	/**
	 *  Thrown when a PageIndexer has problems indexing a WikiPage
	 *
	 *@author     christiana
	 *@created    18. September 2002
	 */
	public static class IndexerException extends Exception {
		/**
		 *  Constructor for the IndexerException object
		 *
