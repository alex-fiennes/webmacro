...
public class RegisterNewUserAction implements PageAction {
   ...
   /**
    *  If it's a GET request, we simply display the register template. If it's a
    *  POST request, do process the registration request, create the user, and
    *  display the register template again. The register template should be
   ...
   public void perform(WikiSystem wiki, WebContext wc, WikiUser user, WikiPage page) throws PageAction.PageActionException {
      ...
      if (method.equalsIgnoreCase("GET")) {
         ...
         try {
            ...
            throw new PageAction.PageActionException(e.toString() + ": " + e.getMessage());
         }
      } else {
