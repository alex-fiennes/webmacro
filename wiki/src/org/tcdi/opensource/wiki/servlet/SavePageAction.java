 ...
 *  created. Otherwise, the existing page is saved as <PageName>
 *
 *  .
 *  <oldversion>and this page is saved in its place as <PageName>
 *
 *    .
 *
 *@author     e_ridge
...
public class SavePageAction implements PageAction {
	...
	/**
	 *  can only save a page if the request is POST and "?save=<pagename>
	 *
	 *  " is in the request
	 *
	...
	/**
	 *  do the saving of the page. When we're done, we redirect to the page so the
	 *  user can view his changes.
	 *
	 *@param  wiki                                Description of the Parameter
	 *@param  wc                                  Description of the Parameter
	 *@param  user                                Description of the Parameter
	...
	/**
	 *  the page name is whatever is behind the "?save=<pagename>
	 *
	 *  " request parameter.
	 *
	 *@param  wiki  Description of the Parameter
