...
public interface WikiSystem extends WikiTermMatcher {
	/**
	 *@param  title  the title of the WikiPage to retrieve. This should be a
	 *      propertly formed WikiTerm
	...
	/**
	 *  Gets the baseDir attribute of the WikiSystem object
	 *
	...
	/**
	 *  return a list of all page names, including names of deleted pages and old
	 *  versions of pages. User should take care to filter these if their use is
	 *  not required.
	 *
	...
	/**
	 *  return an array of all wiki page names that are current (ie, not deleted)
	 *
	...
	/**
	 *  saves the provided page to the wiki system as <code>title</code> takes care
	 *  to preserve existing versions
	 *
	 *@param  page   the WikiPage object to save into this wiki system
	 ...
	 *
	 *@param  title  the title of the WikiPage to delete. This should be a properly
	 *      form WikiTerm
	 */
	 ...
	 *@param  password       the user password. It is recommened this not be clear
	 *      text
	 *@param  attributes     a hashtable of attributes to apply to this user. keys
	...
	/**
	 *  (re)parse the contents of a WikiPage. Should not modify other internals of
	 *  the WikiPage
	 *
	...
	/**
	 *  Index all the current (ie, non-deleted, current version) pages in this wiki
	 *
	 *@exception  Exception  Description of the Exception
	 */
