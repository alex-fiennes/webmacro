...
/**
 * A WikiData object contains an individual piece of data (usually just a java.lang.String) and 
 * has a type.
 * 
 * WikiData is usually used as an array from the WikiPage object.
 * 
 * @author Eric B. Ridge
 */
...
{
   /**
    * @deprecated these constants have been replaced by constants in WikiDataTypes.  Their values should be ignored
    */
    ...
    * @deprecated these constants have been replaced by constants in WikiDataTypes.  Their values should be ignored
    */
   public static final int TYPE_PAGE_REFERENCE = 0;
    ...
    */
   public Object getData ()   { return _text; }
    ...
    * @param new_text the data to set
    */
   public void setData (Object data) { _text = data; }

   /**
    * Set the type for this object
    * @param new_type the type of this object
    */
   public void setType (int new_type)    { _type = new_type; }
    ...
    */
   public boolean isPageReference ()   { return _type == WikiDataTypes.PAGE_REFERENCE; }

   /**
    * is this data object plain text?
    */
   public boolean isText ()   { return _type == WikiDataTypes.PLAIN_TEXT; }
    ...
    */
   public boolean isOfType (int type) { return _type == type; }
   
   
   /**
    * Overloaded to return the toString() value of the internal data structure
    */
   public String toString () { return _text.toString (); }
