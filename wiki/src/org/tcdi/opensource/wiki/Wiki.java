...
public final class Wiki implements WikiSystem, QueueListener {
   ...
   /**
    *  This constructor will load the specified .properties file from the <b>
    *  local filesystem</b>
    *
    * @param  propertiesFilename  absolute path to a .properties file for the
    *      Wiki
   ...
   public WikiUser getUser(String uid) {
      return (WikiUser) (uid != null ? _userStore.get(uid) : null);
   }
