 ...
 *  <li> a WikiAttachment array. Currently, this is not used </code>
 *
 *@author     Eric B. Ridge
...
public class WikiPage implements Serializable {
	...
	String[] _incomingLinks = new String[0];
	String[] _outgoingLinks = new String[0];
	...
	/**
	 *  Default constructor. If using the constructor, must remember to set the
	 *  metadata
	 */
	public WikiPage() {
	...
	/**
	 *  Constructor to set title and author who created the page Sets dateCreated
	 *  to current date/time.<p>
	 *
	 *
	 *
	 *@param  title          the title for this page
	 *@param  authorCreated  Description of the Parameter
	 */
		...
		return
			new Enumeration() {
				...
				public boolean hasMoreElements() {
					return _cursor != _parsedData.length;
				}


				public Object nextElement() {
					return _parsedData[_cursor++];
				}
			};
	}
	 ...
	 */
	public void addRelatedTitle(String title) {
		_relatedTitles = (String[]) ArrayHelper.appendToArray(_relatedTitles, title);
	}


	/**
	 *  Adds a feature to the OutgoingLink attribute of the WikiPage object
	 *
	 *@param  title  The feature to be added to the OutgoingLink attribute
	 */
	public void addOutgoingLink(String title) {
		_outgoingLinks = (String[]) ArrayHelper.appendToArray(_outgoingLinks, title);
	}


	/**
	 *  Adds a feature to the IncomingLink attribute of the WikiPage object
	 *
	 *@param  title  The feature to be added to the IncomingLink attribute
	 */
	public void addIncomingLink(String title) {
		_incomingLinks = (String[]) ArrayHelper.appendToArray(_incomingLinks, title);
	}
	 ...
	 *  .elements() method. The only difference lies in the WM syntax: <pre>
	...
	/**
	 *  Gets the outgoingLinks attribute of the WikiPage object
	 *
	 *@return    The outgoingLinks value
	 */
	...
	/**
	 *  Gets the incomingLinks attribute of the WikiPage object
	 *
	 ...
	 *
	 *@param  isModerated  The new isModerated value
	 */
	...
	/**
	 *  Set the title of this page. updates dateLastModified to current date/time.
	 *  <p>
	 *
	 ...
	 *
	 *@param  data  The new unparsedData value
	 */
	 ...
	 *
	 *@param  data  The new wikiData value
	 */
	 ...
	 *
	 *@param  relatedTitles  a String[] of WikiPage titles that this WikiPage is
	 *      related to
	 */
	...
	/**
	 *  overloaded to return the Title of this page NOTE: This should either return
	 *  the _unparsedData or the _cachedOutput, not the title. Comments anyone?
	 *
