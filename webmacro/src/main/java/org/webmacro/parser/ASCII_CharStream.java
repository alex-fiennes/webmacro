 ...
 * characters (without unicode processing). Modified extensively by Brian Goetz (Oct 2000) to
 * support being able to back up in the buffer.
 */
...
public final class ASCII_CharStream
{
  ...
  public final String GetImage()
  {
    if (tokenBeginBuf == curBuf)
      return new String(curBuf.buffer, tokenBeginPos, curBuf.curPos - tokenBeginPos + 1);
    else
