 ...
 * of this interface is used in the TokenManager implementation generated by JavaCCParser. All the
 * methods except backup can be implemented in any fashion. backup needs to be implemented correctly
 * for the correct operation of the lexer. Rest of the methods are all used to get information like
 * line number, column number and the String that constitutes a token and are not used by the lexer.
...
public interface CharStream
{
   ...
   * MORE. A simple and inefficient implementation of this is as follows : { String t = GetImage();
...
/* JavaCC - OriginalChecksum=995d31c169f1d3d55e372131438a66de (do not edit this line) */
