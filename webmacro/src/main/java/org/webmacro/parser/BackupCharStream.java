...
/**
 * An implementation of interface CharStream. Modified extensively by Brian Goetz (Oct 2000) to
 * support being able to back up in the buffer. Modified to support Unicode input. Convenience
 * one-arg constructor provided.
 */

public final class BackupCharStream
  implements CharStream
{
  ...
  public BackupCharStream(java.io.InputStream dstream,
                          int startline,
                          int startcolumn,
                          int buffersize)
  {
