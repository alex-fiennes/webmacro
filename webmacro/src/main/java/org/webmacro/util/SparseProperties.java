/*
 * Copyright Open Doors Software. 1996-2002. Software is provided according to the MPL license. Open
 * Doors Software provides this software on an as-is basis and make no representation as to fitness
 * for a specific purpose. Direct all questions and comments to support@opendoors.com
 */
...
/**
 * Implement a behavior allowing for undefined properties to return a useful default value such as
 * "" for a string, "0.00" for numeric properties, and so forth.
 * 
 * @author Lane Sharman
 */
