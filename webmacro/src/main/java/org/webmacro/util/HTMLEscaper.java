/*
 * HTML Escaping code Copyright (C) 2000 Marc Palmer / AnyWare Ltd. Acording to Marc, this code may
 * be used under any license. Thanks to Jason Hunter for his great book "JAVA Servlet Programming"
 * used as the source for the entity mappings. Thanks to CARDIACS for making the most joyful music
 * (www.cardiacs.com/button.html) http://www.anyware.co.uk/java for updates and other stuff
 * @author Marc Palmer
...
/**
 * This class will escape characters that have an HTML entity representation. It will not escape
 * standard ASCII characters unless it is necessary (i.e. will not escape ASCI #32 but will escape
 * "&amp;"). Any characters with no corresponding entity are passed through unchanged. It uses a
 * quick string -> array mapping to avoid creating thousands of temporary objects.
 */
