/*
 * FunctionVariable.java Created on March 21, 2003, 12:15 AM
 */
  ...
  extends Variable
{
   ...
   */
  @Override
  public void setValue(Context c,
                       Object v)
      throws PropertyException
  {
  ...
  /**
   * Return the String name of the variable prefixed with a string representing its type, in this
   * case "function:".
   */
  @Override
