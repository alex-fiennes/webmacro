...
public interface ContextTool
{
   ...
   /**
     * Initialize the ContextTool for use in the supplied Context. The 
     * ContextTool should return an object of type ContextTool which 
     * can be used from now on with this Context. If the tool can be
     * used as-is, it should just return itself. Otherwise, if it has
     * to keep state data, it might need to return a clone() or a 
     * new instance. 
     */
   public ContextTool init(Context newContext)
