    ...
    final public Object CExpression () throws ParseException
    {
        ...
        if (op == null)
        {
            ...
            switch (op.kind)
            {
                case OP_EQ:
                    {
                        if (true) return new Expression.CompareEqBuilder(e1, e2);
                    }
                case OP_SET:
                    {
                        if (true) return new Expression.CompareEqBuilder(e1, e2);
                ...
                case OP_NE:
                    {
                        if (true) return new Expression.CompareNeBuilder(e1, e2);
                    }
                case OP_GT:
                    {
                        if (true) return new Expression.CompareGtBuilder(e1, e2);
                    }
                case OP_GE:
                    {
                        if (true) return new Expression.CompareGeBuilder(e1, e2);
                    }
                case OP_LE:
                    {
                        if (true) return new Expression.CompareLeBuilder(e1, e2);
                    }
                case OP_LT:
                    {
                        if (true) return new Expression.CompareLtBuilder(e1, e2);
                    }
                default:
                    {
