 ...
 * Date and Time of Java Class File Generation: Tue Nov 20 15:19:54 PST 2001
 */
 ...
 * This file was generated on Tue Nov 20 15:19:54 PST 2001.
 */
public class Memo implements SQLData, Serializable {
  ...
  public List getNullConstraintViolations() {
    ...
    if (author == null) list.add("author");
  ...
  public void readSQL(SQLInput stream, String sqlTypeName) throws SQLException {
    ...
    subject = stream.readString();
    body = stream.readString();
