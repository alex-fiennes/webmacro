 ...
 * Date and Time of Java Class File Generation: Tue Nov 20 15:12:31 PST 2001
 */
 ...
 * This file was generated on Tue Nov 20 15:12:31 PST 2001.
 */
public class DataTypeSampler implements SQLData, Serializable {
  ...
  protected String textMapping; 
  protected String charMapping; 
  protected BigDecimal numberMapping; 
  protected byte byteMapping; 
  protected int integerMapping; 
  protected long longMapping; 
  protected double doubleMapping; 
  protected Timestamp timestampMapping; 
  protected Date dateMapping; 
  protected Time timeMapping; 
  protected Blob blobMapping; 
  protected Clob clobMapping; 
  protected Memo objectMapping; 
  protected Ref refMapping; 
  protected Array arrayMapping; 
  protected boolean booleanMapping; 
  ...
  public List getNullConstraintViolations() {
    ...
    if (textMapping == null) list.add(textMapping);
