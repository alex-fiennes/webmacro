...
public class SimpleDataTable extends ArrayList implements DataTable {
    ...
    private RowCallback _rowCallback = null;
    public void registerRowCallback(RowCallback rcb){
        _rowCallback = rcb;
    }
    public void addRow(Object[] vals){
        SimpleTableRow strow = new SimpleTableRow(this, vals);
        add(strow);
        if (_rowCallback != null){
            _rowCallback.processRow(strow);
        }
    }
